...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 24 fév. 2023 à 11:42
...
--
-- Base de données : `aws-cloud-practitioner-knowledge-test`
--
...
(1, 'Why is AWS more economical than traditional data centers for applications with varying compute workloads?', '<b>The correct answer is </b> C) Amazon EC2 instances can be launched on demand when needed  <br><b>Because:</b>  The ability to launch instances on demand when needed allows users to launch and terminate instances in\n        response to a varying workload. This is a more economical practice than purchasing enough on-premises servers\n        to handle the peak load.'),
(2, 'Which AWS service would simplify the migration of a database to AWS ?', '<b>The correct answer is </b>B) AWS Database Migration Service (AWS DMS)\n        <b><br>Because:</b>  AWS DMS helps users migrate databases to AWS quickly and securely. The source database remains\n        fully operational during the migration, minimizing downtime to applications that rely on the database. AWS DMS\n        can migrate data to and from most widely used commercial and open-source databases.'),
(3, 'Which AWS offering enables users to find, buy, and immediately start using software solutions in theirAWS environment?', '<b>The correct answer is </b>D) AWS Marketplace <br><b>Because :</b> AWS Marketplace is a digital catalog with thousands of software listings from independent software\n        vendors that makes it easy to find, test, buy, and deploy software that runs on AWS.'),
(4, 'Which AWS networking service enables a company to create a virtual network within AWS?', '<b>The correct answer is</b> D) Amazon Virtual Private Cloud (Amazon VPC) <br><b>Because :</b>  Amazon VPC lets users provision a logically isolated section of the AWS Cloud where users can launch\n        AWS resources in a virtual network that they define.'),
(5, 'Which of the following is an AWS responsibility under the AWS shared responsibility model?', '<b>The correct answer is</b> B) Maintaining physical hardware <br><b>Because :</b> Maintaining physical hardware is an AWS responsibility under the AWS shared responsibility model.'),
